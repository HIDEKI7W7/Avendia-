...
TOOL_CONTRACTS: dict[tuple[str, str], ToolGenerationContract] = {
    ...
    ("planificamos", "sesion-aprendizaje"): _contract(
        ...
        "docente",
        "secuencia didáctica temporizada con anexos para el estudiante",
        (
            "propósito (¿qué?, ¿cómo?, ¿para qué?)",
            "competencia, capacidades, desempeño y estándar del ciclo",
            "reto y situación significativa",
            "evidencia y producto",
            "necesidades de aprendizaje",
            "enfoques transversales, DUA según contexto y trabajo entre pares",
            "inicio, desarrollo y cierre con procesos pedagógicos",
            "criterios e instrumento",
            "retroalimentación",
            "recursos, materiales y referencias",
            "teoría del tema para el estudiante",
            "ficha de trabajo y mapa mental",
        ),
        _DOC_RULES
        + (
            "La suma de tiempos debe corresponder a la duración total.",
            "Inicio, desarrollo y cierre deben contener acciones observables.",
            "La teoría del tema se redacta para el estudiante con ejemplos del contexto.",
            "Las consignas de la ficha se resuelven con la teoría del tema.",
        ),
